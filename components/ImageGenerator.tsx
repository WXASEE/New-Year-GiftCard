...
const ImageGenerator: React.FC<ImageGeneratorProps> = ({ category, onGenerate, error, initialData }) => {
    ...
    <div className="w-full max-w-2xl bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
      <div className="flex items-center mb-6">
        <div className="flex items-center space-x-3">
          ...
          <h2 className="text-2xl font-bold text-gray-800">{t(category.nameKey)}</h2>
        </div>
      </div>
